    ...
    <div className="px-4">
      ...
      >
        <div className="text-center tracking-tight text-slate-300">
            ...
            <p className="mb-4 last:mb-0">Get notified about updates and be the first to get early access to the new, safer and smarter way to archive your files.</p>
          </div>
        <div className="grid grid-cols-1 gap-2">
          ...
          <p className="text-center text-xs text-slate-400">
              By subscribing to our newsletter you accept to receive recurring emails about our product and our company
            </p>
        </div>
      </form>
    </div>
...
export function Footer({ settings } : any) {
  return (
    <Bounded as="footer" className="bg-gray-800 pb-12 text-slate-300 md:pb-12">
      <div className="grid grid-cols-1 justify-items-center gap-20 md:gap-24">
        ...
        <div className="mx-auto w-full max-w-3xl text-center text-xs font-semibold tracking-tight">
          ...
          <Link href="https://prismic.io" className="text-white">
            Prismic
          </Link>
        </div>
      </div>
